...
<template>
  <div class=" w-fit">
    <BaseButton
      ...
      :class="
        {
          'border-sb-tertiary-100 bg-sb-tertiary-100 text-black shadow-sb-ring-sm shadow-sb-tertiary-100/80 ': isOpen,
          'text-white hover:bg-sb-tertiary-200 hover:border-sb-tertiary-200 bg-sb-secondary-300  border-sb-secondary-200 focus-visible:bg-sb-tertiary-200 focus-visible:border-sb-tertiary-200': !isOpen,
          'px-4 ': activeBreakpoint !== 'xs' && activeBreakpoint !== 'sm' && activeBreakpoint !== 'md',
    ...
    <teleport to="body">
      <transition name="scale-and-fade-fast">
        <div
          v-if="isOpen"
          ref="floating"
          v-on-click-outside="[(_: Event) => changeFloatingVisibility(false), { ignore: [reference] }]"
