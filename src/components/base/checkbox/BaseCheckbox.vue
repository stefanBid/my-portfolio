...
<template>
  <div class="inline-flex items-center w-full gap-x-3">
    <input
      ...
      class="bg-white relative border border-white outline-0 focus-visible:outline-0 focus-visible:shadow-sb-ring-sm rounded appearance-none cursor-pointer shrink-0 checked:bg-sb-tertiary-100 checked:border-sb-tertiary-100 transition-sb-normal checked:after:content-[''] checked:after:block checked:after:border-b-2 checked:after:border-r-2 checked:after:border-white checked:after:rotate-45 checked:after:absolute checked:after:left-0.5 checked:after:top-0.5"
